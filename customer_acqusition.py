...
a = numpy.array(transactions_per_user['categ_0'].values, dtype=object)
b = numpy.array(transactions_per_user['categ_1'].values, dtype=object)
c = numpy.array(transactions_per_user['categ_2'].values, dtype=object)
d = numpy.array(transactions_per_user['categ_3'].values, dtype=object)
e = numpy.array(transactions_per_user['categ_4'].values, dtype=object)
